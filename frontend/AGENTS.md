...
- `skills/application-style-guard`: use for any UI, layout, shell, spacing, typography, color, card, button, badge, navbar, or profile styling work that must stay visually consistent, accessible, and aligned to the neutral Ant Design-based application system.
...
1. Apply `skills/application-style-guard` while designing or refactoring the UI.
